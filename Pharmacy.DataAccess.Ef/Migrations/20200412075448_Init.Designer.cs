...
#pragma warning disable 612, 618
            modelBuilder
                .HasAnnotation("DrugVersion", "3.1.1")
                .HasAnnotation("Relational:MaxIdentifierLength", 128)
                .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

            modelBuilder.Entity("Pharmacy.Domain.Action", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.ActionInRole", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pharmacy.Domain.UserInRole", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.VerificationCode", b =>
                {
            ...
            modelBuilder.Entity("Pharmacy.Domain.Action", b =>
                {
                    b.HasOne("Pharmacy.Domain.Action", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Pharmacy.Domain.ActionInRole", b =>
                {
                    b.HasOne("Pharmacy.Domain.Action", "Action")
                        .WithMany("ActionInRoles")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pharmacy.Domain.Role", "Role")
                        .WithMany("ActionInRoles")
