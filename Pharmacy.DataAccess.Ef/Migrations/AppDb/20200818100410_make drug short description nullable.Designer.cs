...
namespace Pharmacy.DataAccess.Ef.Migrations.AppDb
{
    ...
    [Migration("20200818100410_make drug short description nullable")]
    partial class makedrugshortdescriptionnullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy.Domain.DrugStoreAsset", b =>
                {
                    b.Property<int>("DrugStoreAssetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("DrugStoreAssetId");

                    b.HasIndex("DrugStoreId");

                    b.ToTable("DrugStoreAsset","Drug");
                });
