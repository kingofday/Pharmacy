const strings = {
    ...
    weblog: 'وبلاگ',
    remoteDoctor: 'دکتر از راه دور',
    fiveEuroCoupon: 'کوپن 5 یورویی',
    more: 'بیشتر',
    ...
    byMostVisited: 'مرتی سازی بر اساس بیشترین بازدید',
    byFavorites: 'مرتب سازی بر اسای محبوبیت',
    ...
    orderTraceIdIs: 'کد پیگیری تراکنش به شرح زیر می باشد',
