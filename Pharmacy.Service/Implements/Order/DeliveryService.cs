...
namespace Pharmacy.Service
{
    ...
    //    private async Task<IResponse<List<PriceInquiryResult>>> GetTypes(LocationDTO location)
    //    {
    ...
    //    public async Task<Response<GetDeliveryTypesDTO>> GetDeliveryTypes(int PharmacyId, LocationDTO location)
    //    {
    //        var getTypes = await GetTypes(location);
    ...
    //        //ExtraInfo info = null;
    //        try { 
    //            //info = order.ExtraInfoJson.DeSerializeJson<ExtraInfo>(); 
    //        } catch { }
    //        using var deliveryPriceHttp = new HttpClient();
